...
import com.helloworld.generic.common.Config;
import com.helloworld.jfx.res.Res;
...
public class HelloThinkAlikeApp extends Application implements Platform, Loader.OnLoaderEventListener {

	//-- Constants and Enums --------------------------
	@SuppressWarnings("unused")
	private final static String TAG = HelloThinkAlikeApp.class.getSimpleName();
	private final static Object DUMB_OBJECT = new Object();

	//-- Inner Classes and Structures --------------------------
	//-- Delegates and Events --------------------------	
	//-- Instance and Shared Fields --------------------------	
	private static HelloThinkAlikeApp _this;
	...
	public void start(Stage primaryStage) {
		...
		//0.Initialize platform-independent generic.Loader
		Loader loader = Loader.createInstance(this, this);

		//1.Initialize platform-specific, project-specific objects
		...
		//3.Initialize other platform-specific elements 
		_factory = (Factory)new com.helloworld.jfx.domain.Factory();
	...
	public static HelloThinkAlikeApp getInstance() {
		if(_this == null)
			_this = new HelloThinkAlikeApp();
		return _this;
	}
...
//			throw new IllegalArgumentException("platform-dependent Context type mismatched");
	...
	private void replacePrimarySceneContent(String layout_fxml) throws Exception {
        ...
        //_primaryStage.setOpacity(com.helloworld.jfx.common.Constant.Screen.OPACITY);
    }
