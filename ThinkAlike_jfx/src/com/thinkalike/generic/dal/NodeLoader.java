...
public class NodeLoader {
	...
	private final static NodeType[] NodeTypeList = new NodeType[]{NodeType.TypeA, NodeType.TypeB, NodeType.TypeC, NodeType.TypeD, NodeType.TypeE }; 
	private final static String[] AssetsPathList = new String[]{Config.PATH_TYPE_A, Config.PATH_TYPE_B, Config.PATH_TYPE_C, Config.PATH_TYPE_D, Config.PATH_TYPE_E };
	static{
