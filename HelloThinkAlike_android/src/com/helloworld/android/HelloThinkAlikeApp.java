...
public class HelloThinkAlikeApp extends android.app.Application implements Platform, Loader.OnLoaderEventListener {
	//-- Constants and Enums -----------------------------------
	...
	public void onCreate() {
		...
		_factory = (Factory)new com.helloworld.android.domain.Factory();
