...
package com.aqiservice.android;

import android.app.ActivityManager;
import android.content.Context;
import android.os.Environment;

import com.aqiservice.generic.common.Config;
...
public class AQIServiceApp extends android.app.Application implements Platform, Loader.OnLoaderEventListener {
	//-- Constants and Enums -----------------------------------
	...
	public void onCreate() {
		...
		_factory = (Factory)new com.aqiservice.android.domain.Factory();
