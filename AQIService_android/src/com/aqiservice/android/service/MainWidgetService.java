...
public class MainWidgetService extends Service {
    ...
    class WidgetInfo {
    	...
    	private boolean _largeLayout;
    	public WidgetInfo(int widgetId, boolean largeLayout){
    		_widgetId = widgetId;
    		_largeLayout = largeLayout;
    	}
		public int getWidgetId() {return _widgetId;}
		public boolean isLargeLayout() {return _largeLayout;}
    }
	...
	private Set<WidgetInfo> _updateCandidateInfos = new HashSet<WidgetInfo>();
    ...
    private void refreshViewModel(Intent intent) 
    {
		...
		final WidgetInfo widgetInfo = new WidgetInfo(appWidgetId, largeLayout);
    	synchronized(_updateCandidateInfos){
    		_updateCandidateInfos.add(widgetInfo);
    	}
    	_vm_aqi.onRefresh();
    }
    ...
    private void updateWidgetUI() 
    {
    	...
    	synchronized(_updateCandidateInfos){
		for(WidgetInfo widgetInfo : _updateCandidateInfos){
			
			final int appWidgetId = widgetInfo.getWidgetId();
			final boolean largeLayout = widgetInfo.isLargeLayout();
