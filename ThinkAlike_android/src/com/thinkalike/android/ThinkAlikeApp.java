...
package com.thinkalike.android;
...
public class ThinkAlikeApp extends android.app.Application implements Platform, Loader.OnLoaderEventListener {
	//-- Constants and Enums -----------------------------------
	...
	public void onCreate() {
		...
		_factory = (Factory)new com.thinkalike.android.domain.Factory();
